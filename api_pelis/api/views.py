...
class PeliculaViewSet(viewsets.ModelViewSet):
  ...
  serializer_class = PeliculaSerializer #convierte a formato json con  lo establecido en serializers.py


class MarcarPeliculaFavorita(views.APIView):
  authentication_classes = [TokenAuthentication] #tiene que estar autenticado
  permission_classes = [IsAuthenticated] #autenticacion por token
